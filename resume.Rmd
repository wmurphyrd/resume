...
#     }
#     if(any(x$type == "wordcloud")) {
#       wc <- filter(x, type == "wordcloud")
#       cat('<div class = "wordcloud">')
#       wordcloud(wc$title, wc$priority, min.freq = 0,
#                 random.order = F, colors = brewer.pal(4, "Dark2"),
#                 scale = c(1.75, .1))
#       cat("</div>")
#       x <- filter(x, type != "wordcloud")
#     }
